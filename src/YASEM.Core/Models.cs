...
namespace YASEM.Core.Models
{
    ...
    public class Config
    {
        public string Id {get;  set;} = System.Guid.NewGuid().ToString(); //no default
        public required string Name { get; set; } //no default
        public string Author { get; set; } = System.Environment.UserName; //TODO: Get System Username
        ...
        public LogOptions LogOptions { get; set; } = new LogOptions(); //see defaults in LogOptions class
        public ReportingOptions ReportingOptions { get; set; } = new ReportingOptions(); //see defaults in reporting Options class
        public List<TestStep> TestSteps { get; set; } = new List<TestStep>(); //see defaults in TestSteps class
